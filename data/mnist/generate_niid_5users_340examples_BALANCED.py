...
#CLIENT 1 DATA
balanced_list1=balanced_sample_maker(x1_base,y1_base,34) # 1 is number per class 
...
balanced_list2=balanced_sample_maker(x2_base,y2_base,34)
...
balanced_list3=balanced_sample_maker(x3_base,y3_base,34)
...
balanced_list4=balanced_sample_maker(x4_base,y4_base,34)
