...
# GLOBAL PARAMETERS
OPTIMIZERS = ['fedavg', 'fedprox', 'feddane', 'fedddane', 'fedsgd', 'fedprox_origin','fedprox_mse','fedavg_mse']
DATASETS = ['sent140', 'nist', 'shakespeare', 'mnist', 'turbofan', 
'synthetic_iid', 'synthetic_0_0', 'synthetic_0.5_0.5', 'synthetic_1_1','iris']  # NIST is EMNIST in the paepr
...
MODEL_PARAMS = {
    ...
    'iris.cnn': (3,),  # num_classes
    'iris.mclr': (3,), # num_classes
    'turbofan.cnn': (2,),  # num_states (dont need maintenance, warning) 
    'turbofan.mclr': (2,), # num_states (dont need maintenance, warning)
    'turbofan.mclr_regression': (1,), # nodes in output layer
    'turbofan.stacked_lstm': (24,50,100) # seq_len(25 sensors), size_seq, num_hidden
}
