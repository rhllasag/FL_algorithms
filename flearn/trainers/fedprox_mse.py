    ...
    def train(self):
        ...
        for i in range(self.num_rounds):
            ...
            if i % self.eval_every == 0:
                ...
                tqdm.write('At round {} MAE: {}'.format(i, np.sum(stats[3])))  # testing accuracy
                tqdm.write('At round {} MSE: {}'.format(i, np.sum(stats_train[4])))
        ...
        tqdm.write('At round {} MAE: {}'.format(self.num_rounds, np.sum(stats[3])))
        tqdm.write('At round {} MSE: {}'.format(self.num_rounds, np.sum(stats_train[4])))