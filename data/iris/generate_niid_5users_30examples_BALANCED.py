...
balanced_list2=balanced_sample_maker(x2_base,y2_base,10)
...
balanced_list3=balanced_sample_maker(x3_base,y3_base,10)
...
balanced_list5=balanced_sample_maker(x5_base,y5_base,10)
